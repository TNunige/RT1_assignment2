#!/usr/bin/env python
# This code creates a ROS node(Action Client) 
# it initizalizes a custom action client to send goals to server 
...
class  ActionClient:
    ...
    def odom_callback(self, data):
        # Extract position and linear velocity information from the odometry message
        position = data.pose.pose.position
        linear_velocity = data.twist.twist.linear

        # Create a custom message to publish position and velocity information
        pos_msg = pos()
